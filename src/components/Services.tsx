    ...
    <section id="solucoes" className="premium-shell relative overflow-hidden border-y border-white/15 bg-[#0043ce] py-16 sm:py-24 lg:py-32">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          <div className="soft-label mb-4">Soluções Corporativas</div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight">
            Engenharia digital focada em{' '}
          ...
          <p className="mt-4 text-base sm:text-lg text-blue-100 leading-relaxed">
            Desenvolvemos a presença digital que sua empresa precisa para se posicionar como líder de mercado e vender todos os dias com alta previsibilidade.
          </p>
        </div>
